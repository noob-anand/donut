...
const Login = () => {
    return (
        <div className='text-white '>
            ...
            <div className='py-14 container mx-auto flex flex-col justify-center items-center'>
                <h1 className='text-3xl text-center font-medium'>Login/Signup to Connect with your friends</h1>


                <div className="mt-10 flex justify-center flex-col gap-2 p-10">


                    <button
                        className="flex items-center bg-[#0c142ab3] border  rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    ...
                    <button
                        className="flex items-center bg-[#0c142ab3]  border rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" onClick={()=>{signIn("github")}}>
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
